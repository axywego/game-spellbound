...
void AnimationController::updateSpriteTextureRect() {
...
void AnimationController::addAnimation(const std::string& name, const std::vector<sf::IntRect>& frames, float frameDuration, bool loop, bool flipX) {
...
bool AnimationController::hasPenultFrame() {
...
bool AnimationController::hasLastFrame() {
